...
let postActions = (function () {
        ...
        function editPost(postID, post) {
            let tmp = Object.assign({}, getPhotoPost(postID));
...
console.log(postActions.getPhotoPost(1));
console.log(postActions.validatePhotoPost(OnePost));
postActions.editPost(1, forEdit);
console.log(postActions.getPhotoPost(1));
postActions.addPhotoPost(OnePost);
console.log(postActions.photoPosts);
console.log(postActions.getPhotoPosts(0, 10));
console.log(postActions.getPhotoPosts(0, 10, filerFound));
console.log(postActions.getPhotoPosts(0, 10, {author: 'Main Person'}));
console.log(postActions.getPhotoPosts(0, 10, {hashtags: ['Italy']}));
postActions.removePhotoPost(1);
console.log(postActions.getPhotoPost(1));
